 ...
 *
 * 2nd solution with Java Util Logging
 *
...
public class Menu2 {
    ...
    /**
     * Sets up and returns a Logger object that logs messages to a file.
     *
     * @return  a Logger object that logs messages to a file.
     */
    public static Logger getLogger() {
        ...
        try {
            fileHandler = new FileHandler("./menu_cf.log",true);
